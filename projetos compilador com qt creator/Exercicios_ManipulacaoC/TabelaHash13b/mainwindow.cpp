    ...
    , ui(new Ui::MainWindow)
{
    ...
    try {
        ...
        arquivo.close();
        ui->textEdit->clear();
            teste=new ed2::ManipularArquivo(nomeDoArquivoNoDisco,tamanho,colisoes);
            teste->lerArquivo();
...
void MainWindow::atualizarTabela(){
    ...
    for(int c=0; c<tamanhoChaves;c++){
        ...
        QTableWidgetItem *itemTipoDeContrato = new QTableWidgetItem(listaDeProfessores->obterDados(i,c).getTipo_de_contrato());
