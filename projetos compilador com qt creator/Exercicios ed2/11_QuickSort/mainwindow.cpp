...
void MainWindow::on_pushButton_Tamanho_clicked()
{
    try{
        ...
        ui->lineEdit_Exec_Vet_SS->setText(n_exec);
        ...
        ui->lineEdit_Exec_Vet_IS->setText(n_exec);
        ...
        n_exec=QString::number(o->getN_exec());
        ui->lineEdit_Exec_Vet_BB->setText(n_exec);
        ...
        n_exec=QString::number(o->getN_exec());
        ui->lineEdit_Exec_Vet_MS->setText(n_exec);
        ...
        timer.restart();
        o->heapSort();
        qint64 heapSortTime=timer.elapsed();
        vet_esc=o->toStringHS();
        ui->textEdit_Ordenado_HS->setText(vet_esc);

        n_exec=QString::number(o->getN_exec());
        ui->lineEdit_Exec_Vet_HS->setText(n_exec);

        tempo=QString::number(millisecondsToFloat(heapSortTime));
        ui->lineEdit_tempoHS->setText(tempo+"ms");

        //quicksort
        timer.restart();
        o->quickSort();
        qint64 quickSortTime=timer.elapsed();
        vet_esc=o->toStringQS();
        ui->textEdit_Ordenado_QS->setText(vet_esc);

        n_exec=QString::number(o->getN_exec());
        ui->lineEdit_Exec_Vet_QS->setText(n_exec);

        tempo=QString::number(millisecondsToFloat(quickSortTime));
        ui->lineEdit_tempoQS->setText(tempo+"ms");
